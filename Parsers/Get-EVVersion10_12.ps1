<#
	.SYNOPSIS
		Get-EVVersion10_12.ps1 detects if either Agent or Vault log format and extract essential information for ticket documenting
		Fixed a bug with non-English language Agent log parsing
