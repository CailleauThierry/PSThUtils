...
<#
	.SYNOPSIS
		Get-EVVersion.ps1 stable on 10/22/2017 Detect if either Agent or Vault log format and extract essential information for ticket documenting
	...
	.NOTES
		Check this script version information in Get-EVVersion.history.zip (Automatically Generated by ISESteroids)
