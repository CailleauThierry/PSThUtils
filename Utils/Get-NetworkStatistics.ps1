function Get-NetworkStatistics {
    <#
      ...
      .LINK
        ...
        updated from https://www.powershellgallery.com/packages/WFTools/0.1.1/Content/Get-NetworkStatistics.ps1 on 07_13_2022
    #>    
...
<# PS C:\Posh\External\Get-NetworkStatistics> .\Get-NetworkStatisticExt.ps1
    .\Get-NetworkStatisticExt.ps1 : File C:\Posh\External\Get-NetworkStatistics\Get-NetworkStatisticExt.ps1 cannot be
    loaded. The file C:\Posh\External\Get-NetworkStatistics\Get-NetworkStatisticExt.ps1 is not digitally signed. You
    ...
    At line:1 char:1
    + .\Get-NetworkStatisticExt.ps1
    + ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : SecurityError: (:) [], PSSecurityException
    + FullyQualifiedErrorId : UnauthorizedAccess
PS C:\Posh\External\Get-NetworkStatistics> #>
# "ps1 is not digitally signed" can be resolved even wit RemoteSigned execution policy when runn PowerShell as Administrator. Otherwise works OOB from PS ISE